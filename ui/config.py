...
from image_process_app import configs as app_configs

from image_process_app.logger import logger
...
def get_default_config():
    ...
    with pkg_resources.open_text(app_configs, config_file) as f:
...
def test_get_config():
    current_config_file = 'image_process_app/configs/app_config.yaml'
    config = get_config(current_config_file, None)
